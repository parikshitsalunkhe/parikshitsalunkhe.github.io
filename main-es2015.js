...
class HomeComponent {
    ...
    ngOnInit() {
        if (this.isProduction) {
            this.imgPath =
                'http://www.sevenseas-intl.com/assets/parikshitPortfolio/IMGDP_1234.jpg';
        }
        else {
